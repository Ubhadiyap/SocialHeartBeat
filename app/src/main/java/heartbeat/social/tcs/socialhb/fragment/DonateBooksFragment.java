 ...
 */
public class DonateBooksFragment extends Fragment
{
    ...
    {
        View rootView = inflater.inflate(R.layout.fragment_donate_books, container, false);
    ...
    public void showWarningDialog(){
        ...
        donateItemGetConfirmation.setContentText("Do you want to donate "+numberPicker.getValue() + " books ?");
