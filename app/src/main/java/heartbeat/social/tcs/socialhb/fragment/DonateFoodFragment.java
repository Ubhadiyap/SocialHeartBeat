...
public class DonateFoodFragment extends Fragment
{
    ...
    {
        View rootView = inflater.inflate(R.layout.fragment_donate_food, container, false);
    ...
    public void showWarningDialog(){
        ...
        donateItemGetConfirmation.setContentText("Do you want to donate "+numberPicker.getValue() + " Food Items ?");
