 ...
 */
public class DonateEWasteFragment extends Fragment
{
    Button btnSubmit;
    EditText editText;
    ...
    {
        View rootView = inflater.inflate(R.layout.fragment_donate_ewaste, container, false);
    ...
    public void showWarningDialog(){
        ...
        donateItemGetConfirmation.setContentText("Do you want to donate "+numberPicker.getValue() + " Ewaste ?");
